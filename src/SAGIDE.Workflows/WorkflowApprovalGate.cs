...
/// </summary>
public sealed class WorkflowApprovalGate
{
    ...
    /// </summary>
    public async Task ActivateApprovalStepAsync(
        WorkflowStepDef stepDef, WorkflowInstance inst, CancellationToken ct)
    {
        ...
        var prompt   = stepDef.ApprovalPrompt is not null
            ? _renderer.RenderStep(
                stepDef.ApprovalPrompt, inst.InputContext, inst.StepExecutions, 32_000)
    ...
    /// </summary>
    public Task<bool> HandleApprovalAsync(
    ...
    public void ScheduleApprovalTimeout(
