...
/// </summary>
internal sealed class WorkflowLifecycleManager
{
    ...
    internal WorkflowLifecycleManager(
    ...
    internal async Task<WorkflowInstance> StartAsync(StartWorkflowRequest req, CancellationToken ct)
    {
    ...
    internal async Task RecoverRunningInstancesAsync(CancellationToken ct)
    {
    ...
    internal async Task PauseAsync(string instanceId, CancellationToken ct = default)
    {
    ...
    internal async Task ResumeAsync(string instanceId, CancellationToken ct = default)
    {
    ...
    internal async Task CancelAsync(string instanceId, CancellationToken ct = default)
    {
        if (!_store.TryGet(instanceId, out var inst, out _)) return;
    ...
    internal async Task UpdateContextAsync(
    ...
    internal List<WorkflowDefinition> GetAvailableDefinitions(string? workspacePath = null)
    {
