...
///
/// Implements <see cref="IWorkflowEngine"/> so callers can depend on the interface
/// and the concrete class can move to its own assembly in a future phase.
/// </summary>
