...
/// </summary>
internal static class WorkflowStepEvaluators
{
    // ── Router evaluation ──────────────────────────────────────────────────────
    ...
    /// </summary>
    internal static string? EvaluateRouter(WorkflowStepDef routerStep, WorkflowInstance inst)
    {
    ...
    internal static bool EvaluateCondition(string condition, WorkflowStepExecution dep)
    {
    ...
    internal static bool EvaluateContains(string condition, string output)
    {
    ...
    internal static (bool Passed, string Reason) EvaluateConstraintExpr(string expr, WorkflowInstance inst)
    {
        expr = expr.Trim();
    ...
    internal static bool CompareInts(int actual, string op, int expected) => op switch
    {
        "==" => actual == expected,
        "!=" => actual != expected,
        ">=" => actual >= expected,
    ...
    internal static bool CompareDoubles(double actual, string op, double expected) => op switch
    {
    ...
    internal static bool IsInstanceDone(WorkflowInstance inst, WorkflowDefinition def)
        => def.Steps
    ...
    internal static void SkipDownstream(string failedStepId, WorkflowInstance inst, WorkflowDefinition def)
    {
    ...
    internal static void RecordAudit(
    ...
    internal static void ResetAllStepsForNewIteration(
    ...
    internal static void ResetLoopBodyForNewIteration(
        string loopTargetId, WorkflowInstance inst, WorkflowDefinition def)
    {
    ...
    internal static HashSet<string> GetDescendantStepIds(string rootId, WorkflowDefinition def)
    {
    ...
    internal static void InjectConvergenceHints(
